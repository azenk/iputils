...
func TestSetBits(t *testing.T) {
	...
	testCases := []ipSetTestCase{
		...
		ipSetTestCase{net.ParseIP("10.0.15.0"), 0xff, 12, 8, net.ParseIP("10.15.240.0"), nil},
		...
		ipSetTestCase{net.ParseIP("2001:db8:0:1::"), 0xf3f2f1f0, 72, 24, net.ParseIP("2001:db8:0:1:00f2:f1f0::"), nil},
